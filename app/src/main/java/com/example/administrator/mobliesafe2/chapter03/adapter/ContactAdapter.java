package com.example.administrator.mobliesafe2.chapter03.adapter;
...
import com.example.administrator.mobliesafe2.chapter03.ContactSelectActivity;

import java.util.List;

public class ContactAdapter extends BaseAdapter {
    private List<com.example.administrator.mobliesafe2.chapter03.entity.ContactInfo> contactInfos;
    private Context context;


    public ContactAdapter(List<com.example.administrator.mobliesafe2.chapter03.entity.ContactInfo> systemContacts, ContactSelectActivity context) {
        super();
